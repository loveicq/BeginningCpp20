...
5. 第5题
    ...
    *****************************************************************/
    ...
    ```cpp
    Larger of 3.5 and 2.5 is (此实例化已被调用 1 次)3.5
    Larger of 5.6 and 10.6 is (此实例化已被调用 2 次)10.6
    (此实例化已被调用 1 次)Larger of "A" and "Z" is "Z"
    ```
...
6. 第6题
    ...
    *****************************************************************/
    ...
    ```cpp
    -2    4   -5    6   10  -40   56    4   67   45

    Sorted integers:
    -40   -5   -2    4    4    6   10   45   56   67
    ...
    Floating-point values to be sorted:
        -2.5       1.4     -2.55       6.3      10.1     -40.5        56
        4.7      67.3        45

    Sorted floating-point values:
        -40.5     -2.55      -2.5       1.4       4.7       6.3      10.1
        45        56      67.3
    ```
